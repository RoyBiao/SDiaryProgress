 ...
 * @author biao
 */
public abstract class YiBaseActivity extends Activity implements YiToastProxiable,
		YiLocalServiceServiceBinderProxiable,YiDialogProxiable,YiDialogExtProxiable,YiHandlerProxiable
{
	...
	public void showProgressDialog(String msg, DialogInterface.OnCancelListener listener,
								   boolean cancelable) {
