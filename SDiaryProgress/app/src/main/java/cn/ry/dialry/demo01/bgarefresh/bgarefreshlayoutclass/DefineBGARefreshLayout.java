package cn.ry.dialry.demo01.bgarefresh.bgarefreshlayoutclass;
 ...
 */
public class DefineBGARefreshLayout extends LinearLayout {
    private static final String TAG = DefineBGARefreshLayout.class.getSimpleName();

    private DefineBGARefreshViewHolder mRefreshViewHolder;
    /**
    ...
    public DefineBGARefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onFinishInflate() {
        ...
        if (getChildCount() != 2) {
            throw new RuntimeException(DefineBGARefreshLayout.class.getSimpleName() + "必须有且只有一个子控件");
        }
    ...
    public void setRefreshViewHolder(DefineBGARefreshViewHolder refreshViewHolder) {
    ...
    public interface BGARefreshLayoutDelegate {
         ...
         * 开始刷新
         */
        void onBGARefreshLayoutBeginRefreshing(DefineBGARefreshLayout refreshLayout);
         ...
         */
        boolean onBGARefreshLayoutBeginLoadingMore(DefineBGARefreshLayout refreshLayout);
    }
