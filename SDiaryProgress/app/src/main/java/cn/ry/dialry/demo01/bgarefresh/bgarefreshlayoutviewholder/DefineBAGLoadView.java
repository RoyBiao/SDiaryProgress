package cn.ry.dialry.demo01.bgarefresh.bgarefreshlayoutviewholder;
...
//                mMoocRefreshView.setOriginalImage(mOriginalResId);
//            }
            if(mOriginalResId!=-1){
                mMoocRefreshView.setOriginalImage(mOriginalResId);
            }
     ...
     */
    private void setOriginalBitmap(Bitmap originalBitmap) {
        mOriginalBitmap = originalBitmap;
    }

    public void setOriginalResId(int originalResId) {
        mOriginalResId = originalResId;
    }
