 ...
 */
public abstract class DefineBGARefreshViewHolder {
    /**
     ...
     */
    protected float mSpringDistanceScale = SPRING_DISTANCE_SCALE;

    protected Context mContext;
    /**
     * 下拉刷新上拉加载更多控件
     */
    protected DefineBGARefreshLayout mRefreshLayout;
    /**
     * 下拉刷新控件
     */
     ...
     * 头部控件移动动画时常
     */
    protected int mTopAnimDuration = 500;

    /**
     * @param context
     * @param isLoadingMoreEnabled 上拉加载更多是否可用
     */
    public DefineBGARefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
     ...
     * @param refreshLayout
     */
    public void setRefreshLayout(DefineBGARefreshLayout refreshLayout) {
