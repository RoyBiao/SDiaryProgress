...
public class YiFileUtils {
    ...
    public static String getStorePath() {
        if (mStorePath == null) {
            ...
            mStorePath = path;
            YiLog.getInstance().i("store path:" + mStorePath);
        }
        return mStorePath;
    }
    ...
    public static String saveBitmap(Bitmap b) {
        ...
        YiLog.getInstance().i("saveBitmap:jpegName = " + jpegName);
        ...
        try {
            ...
            YiLog.getInstance().i("saveBitmap成功");
            bos.flush();
            return path;
        } catch (IOException e) {
            YiLog.getInstance().i("saveBitmap:失败");
            e.printStackTrace();
        } finally {
            try {
                if (bos != null) {
