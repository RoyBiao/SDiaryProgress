package cn.ry.dialry.demo01.bgarefresh.analyzerecyclerviewwithbgarefreshlayout;
...
import cn.ry.dialry.demo01.bgarefresh.baseactivity.BaseActivity;
import cn.ry.dialry.demo01.bgarefresh.bgarefreshlayoutviewholder.DefineBAGRefreshView;
import cn.ry.dialry.demo01.bgarefresh.recycleradapter.RecyclerViewAdapter;

/**
 * Created by fml on 2015/12/3 0003.
 */
public class DefineRefreshActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    private void initView() {
        ...
        mTitle.setText("自定义刷新样式");
        mBGARefreshLayout = (BGARefreshLayout) findViewById(R.id.define_bga_refresh);
        mRecyclerView = (RecyclerView) findViewById(R.id.define_bga_recycler);
        //设置刷新和加载监听
    ...
    private void setBgaRefreshLayout() {
        //设置刷新样式
        mBGARefreshLayout.setRefreshViewHolder(new DefineBAGRefreshView(mContext, true, true));
    }
    /** 设置RecyclerView的布局方式 */
